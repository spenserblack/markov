...
// TestNewPrefix1 calls generator.New with prefixLen=1 and confirms that the
...
// TestNewPrefix2 calls generator.New with prefixLen=2 and confirms that the
// returned generator.BytesGenerator struct contains the expected contents.
